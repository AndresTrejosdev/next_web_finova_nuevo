              ...
              <div className="row" style={{ gap: '32px 0' }}>
                ...
                <div className="col-lg-6 mb-4">
                  <div className="calculator-input">
                    ...
                    />
                    <div className="d-flex justify-content-between" style={{ fontSize: '14px', color: '#666', fontWeight: '500' }}>
                      <span>$180,000</span>
                      <span>$2,000,000</span>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-md-6 mb-3 mb-md-0">
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '12px' }}>
                      ...
                      <h5 style={{ fontSize: '16px', fontWeight: '500', margin: 0, opacity: '0.9' }}>
                        Cuota mensual
                      </h5>
                    </div>
                    <h3 style={{ fontSize: '2.5rem', fontWeight: '700', margin: 0 }}>
